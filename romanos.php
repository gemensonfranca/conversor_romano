...
if (isset($_GET['romano'])) {
    ...
    $algarismo->romano  = $_GET['romano'];

    if ($_GET['romano'] === "") {
        $_SESSION['flash_error'] = "O campo de Algarismo Romano precisa ser preenchido!";
    }
}
    ...
    <main class="form-signin">
        ...
        <div class="row">
            ...
            <div id="coluna_2" class="col-4 pt-5">
                ...
                if (isset($_GET['romano']) AND isset($_SESSION['flash_error'])) {
                ...
                <?php include "components/form_romanos.php"; ?>
